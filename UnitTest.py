...
class QuestionsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.planets = Planets('Mars','6.4171×10^23', '2', '2,1.52 AU', '144.4 million km^2', '1.88 Earth Years', ['Phobos,Deimos'])
    ...
    def test_multiply(self):
        ...
        answerstring = completeanswer(4,selected_questions,self.planets)
        #answerstring = 'Mass is 3.3011Ã—10^23'
        print(answerstring)
